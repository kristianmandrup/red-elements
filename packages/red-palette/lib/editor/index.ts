...
import { PaletteEditorConfiguration, IPaletteEditorConfiguration } from './configuration';
...
import { NodeModuleManager } from './node-module/manager';
import { SettingsPaneManager } from './settings-pane/index';
...
@delegator({
  container,
  map: {
    configuration: 'IPaletteEditorConfiguration',
    nodeManager: 'IPaletteEditorNodeManager',
    nodeModuleManager: 'INodeModuleManager',
    settingsPaneManager: 'ISettingsPaneManager'
  }
})
export class PaletteEditor extends Context implements IPaletteEditor {
  ...
  nodeModuleManager: NodeModuleManager
  settingsPaneManager: SettingsPaneManager
